    ...
    >
      ...
      <div
        className={`rounded-xl border bg-zinc-900/20 ${
          hasContent ? "border-zinc-800/30 w-[400px] max-w-full h-[200px] p-2 sm:p-2.5" : "border-transparent p-0"
        }`}
      >
        ...
        <div className="rounded-lg border border-zinc-800/30 bg-zinc-900/10 overflow-hidden w-full h-[180px]">
          <div
            ref={containerRef}
            id={CONTAINER_ID}
            className="w-[260px] max-w-full h-full [&_img]:max-w-full [&_img]:h-auto"
          />
        </div>
      </div>
    </div>
